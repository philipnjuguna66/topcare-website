...
<div class="bg-secondary-900 text-whitemt-0 pt-0 sticky  top-0 left-0 right-0 z-50 " x-data="{ open: false }">
    <div class=" lg1:mx-auto lg:w-4/5 max-w-7xl hidden lg:block text-white">
           ...
           <div class="flex flex-row justify-between space-x-4">
                <div class="text-white">
                    <div class="flex flex-row gap-2">
                        ...
                        <a href="https://www.facebook.com/topcarelandsinvestmentltd" target="_blank">Facebook</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-2">
                        ...
                        <a href="https://www.twitter.com/@topcarelandske/" target="_blank">Twitter</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-2">
                        ...
                        <a href="https://www.instagram.com/topcarelandske/" target="_blank">Instagram</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-2">
                        ...
                        <a href="https://www.youtube.com/@topcarelandslimited" target="_blank">Youtube</a>
                    </div>
