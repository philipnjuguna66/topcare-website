...
<div class="bg-secondary-900 text-white md:fixed md:top-0 left-0 right-0 md:z-50 mt-0 pt-0" x-data="{ open: false }">
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-md shadow-primary-950/50 py-2">
        <div class="grid grid-cols-2 gap-2 justify-between mx-auto  max-w-7xl w-4/5">
