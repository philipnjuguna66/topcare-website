...
<div class="bg-secondary-900 text-white top-0 left-0 right-0 z-50 mt-0 pt-0" x-data="{ open: false }">
    ...
    <nav class="sticky bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-md shadow-primary-950/50">
