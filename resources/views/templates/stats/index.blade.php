...
background-image: url({{ \Illuminate\Support\Facades\Storage::url($section->extra['bg_image'] ) }});"
    ...
    <div class="mx-auto max-w-8xl px-6 lg:px-4 z-2 absolute md:right-[25%] md:left-[50%] md:top-[50%] fixed" style="transform: translate(-25%, -50%); ">
        <div class="">
            ...
            <dl class="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4 z-20 opacity-100 " >
